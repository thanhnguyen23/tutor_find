...
<head>
    ...
    <title>Nhắc nhở và khiển trách</title>
    <style>
        ...
        <div class="card">
            <div class="card-section">
                <div class="alert">
                    ...
                    <div>
                        <p class="alert-title">Nhắc nhở: Bạn đã bỏ lỡ một buổi dạy</p>
                        <p class="alert-desc">Vui lòng liên hệ học viên để sắp xếp buổi bù và tránh tái diễn.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card-section separate">
                <p class="footer-note">Nếu có lý do chính đáng, vui lòng phản hồi qua hệ thống để được xem xét.</p>
                <div class="actions">
